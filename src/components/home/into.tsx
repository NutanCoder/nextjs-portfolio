  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4 text-center">
      <img
        src="/nutan.png"
        alt="Nutan"
        className="w-64 h-64 rounded-full shadow-lg mb-4 transition-transform duration-500 ease-in-out hover:scale-110"
      />

      <h1 className="text-3xl font-bold text-gray-800">Nutan</h1>
